...
void Mission::generateMissions(int nbVehicule, Date dateDebut, Date dateFin)
{
	...
	ofstream fichier("C:\\Users\\Aymane\\Documents\\Visual Studio 2012\\Projects\\ProjetBus\\Debug\\Mission.csv", ios::out | ios::trunc);  // ouverture en écriture avec effacement du fichier ouvert
    if(fichier)
    {
